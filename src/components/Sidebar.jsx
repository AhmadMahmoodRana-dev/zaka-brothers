...
const Sidebar = () => {
  ...
  return (
    <div
      className={`fixed top-0 left-0 h-screen z-50 transition-all duration-300 ease-in-out shadow-xl flex flex-col
        ${isDark 
    ...
    >
      {/* Header */}
      <div
        className={`flex items-center h-16 px-4 border-b transition-all duration-300 flex-shrink-0
          ${isDark 
            ...
            return (
              ...
              >
                ...
                {item.link && !item.subItems ? (
                  <Link
                    to={item.link}
                    className={`flex items-center w-full px-4 py-3 transition-all duration-200 ease-in-out relative rounded-lg
                      ${isCollapsed ? "justify-center" : "justify-between"}
                      ${
                ...
                {isCollapsed && hoveredItem === item.name && (
                  <div
                    className={`absolute left-full ml-2 z-50 rounded-lg shadow-2xl border min-w-48
                      ${
                        isDark
                  ...
                  >
                    ...
                    {item.link && !item.subItems ? (
                      <Link
                        to={item.link}
                        className={`block px-4 py-3 font-semibold transition-all duration-150 rounded-t-lg
                          ${
                            isActiveMain
                              ? isDark
                      ...
                      <>
                        <div className={`px-4 py-2 font-semibold border-b rounded-t-lg ${
